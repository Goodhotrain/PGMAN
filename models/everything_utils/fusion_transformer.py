...
from timm.models.vision_transformer import init_weights_vit_timm, trunc_normal_
import torch.nn as nn
from functools import partial
import torch
from models.everything_utils.layers import FusionBlock
...
if __name__ == '__main__':
    ...
    out = model(video={'all_tokens': v, 'attention_mask': torch.ones_like(v)}, audio={'all_tokens': a, 'attention_mask': torch.ones_like(a)})
    print(out['video_audio']['embed'].shape)